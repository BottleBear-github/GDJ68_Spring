	...
	<section class="container mt-5">
		...
		<form class="col-md-4 ms-auto" action="./add" method="post">
			<div class="row g-3 align-items-center">
				...
				<input type="text" class="form-control" id="noticeSubject"  name="noticeSubject" placeholder="제목을 입력하세요"><br>
			</div>
			
			<div class="row g-3 align-items-center">
				<label for="noticeName" class="col-form-label mt-5">작성자</label>
				<input type="text" class="form-control" id="noticeName"  name="noticeName" placeholder="작성자를 입력하세요"><br> 
			</div>
			
			<div class="row g-3 align-items-center">
				<label for="noticeContents" class="col-form-label mt-5">내용</label>
				<input type="textarea" class="form-control" id="noticeContents"  name="noticeContents" placeholder="내용을 입력하세요"><br> 
			</div>
